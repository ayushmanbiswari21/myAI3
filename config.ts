...
export const AI_NAME = "Food Recipe ChatBot";
export const OWNER_NAME = "Ayushman Biswari";

export const WELCOME_MESSAGE = `Hello! I'm ${AI_NAME}, an AI assistant created by ${OWNER_NAME}. I can suggest recipes, help you adapt dishes to your diet, and recommend options from different cuisines based on the recipes you've uploaded.`;
...
export const PINECONE_INDEX_NAME = "foodrecipechatbot";
