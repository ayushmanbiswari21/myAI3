...
export default function Chat() {
  ...
  // Setup for browser SpeechRecognition (audio → text)
  useEffect(() => {
    if (typeof window === "undefined") return;
  ...
  // 🔊 handle clicking the microphone (start/stop recording)
    ...
    if (!isRecording) {
      try {
        ...
        recognition.onresult = (event: any) => {
          ...
          form.setValue("message", current + space + transcript);
        };

        recognition.onerror = () => {
          setIsRecording(false);
          toast.error("There was a problem with voice input.");
        };
  ...
  return (
    <div className="flex h-screen items-center justify-center font-sans bg-gradient-to-b from-amber-50 via-orange-50 to-rose-50">
      <main className="w-full h-screen relative">
            ...
            <ChatHeader>
              ...
              <ChatHeaderBlock className="justify-end">
                <Button
                  variant="outline"
                  size="sm"
                  className="cursor-pointer bg-white/80 border-amber-200 hover:bg-amber-50"
                  onClick={clearChat}
                >
            ...
            <section className="flex-1 flex flex-col justify-end">
              <div className="rounded-3xl bg-chat-card border shadow-xl px-4 py-4 float-in">
                ...
                <div className="flex flex-col items-center justify-end min-h-[260px] gap-3">
                  ...
                  {/* ⚠️ AI-generated disclaimer – under the messages area */}
                  <p className="w-full disclaimer">
                    ⚠️ Recipes are <strong>AI-generated</strong>. Please verify ingredients, allergens, and cooking safety before using.
        ...
        {/* Bottom input bar */}
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-gradient-to-t from-amber-50/95 via-amber-50/70 to-transparent overflow-visible pt-13">
